...
namespace LearnOpenTK
{
    ...
    {
        private readonly float[] _vertices =   //立方体之六个面,每一个面由二个三角形组成
        {
        ...
        private readonly Vector3[] _cubePositions =//10个立方体之位置坐标
        {
            new Vector3(0.0f, 0.0f, 0.0f),
            new Vector3(2.0f, 3.0f, -5.0f),
            new Vector3(-1.5f, -2.2f, -2.5f),
            new Vector3(-3.8f, -2.0f, -6.3f),
        ...
        private Shader _lampShader;//电筒渲染

        private Shader _lightingShader;//光线渲染

        private Texture _diffuseMap;//纹理

        private Texture _specularMap;//纹理
        ...
        protected override void OnRenderFrame(FrameEventArgs e)
        {
            ...
            */
            ...
            for (int i = 0; i < _pointLightPositions.Length; i++)
            {
                ...
                lampMatrix *= Matrix4.CreateScale(0.8f);
                lampMatrix *= Matrix4.CreateRotationZ(tick);
